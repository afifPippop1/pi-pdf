...
export function HomePage() {
  ...
  return (
    <div className="lg:max-w-4xl w-full flex flex-col items-center">
      <h1 className="lg:text-3xl text-2xl font-bold text-gray-800 mb-2">Welcome to Pi-DF</h1>
      <p className="text-gray-500 text-xs lg:text-base mb-8">Upload and annotate your pdf easily</p>
      <Dropzone
        onDrop={async (files) => {
      ...
      >
        {({ getRootProps, getInputProps }) => (
          ...
          >
            ...
            <p className="text-xs md:text-base text-gray-500">Start by dropping your file's here</p>
